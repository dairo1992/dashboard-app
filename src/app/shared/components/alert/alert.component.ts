import { ChangeDetectionStrategy, Component, effect, EventEmitter, input, OnDestroy, OnInit, output, signal, WritableSignal } from '@angular/core';
...
export class AlertComponent implements OnInit, OnDestroy {
  // Estos inputs ahora son opcionales ya que principalmente usaremos el servicio
  ...
  ngOnInit(): void {
    // No necesitamos hacer nada especial en ngOnInit
  }
